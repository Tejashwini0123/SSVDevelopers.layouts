...
async function dbConnect() {
  ...
  // Configure public DNS servers (Google & Cloudflare) to guarantee MongoDB Atlas SRV resolution
  // on local networks whose default DNS router gateways fail to resolve SRV records.
  try {
